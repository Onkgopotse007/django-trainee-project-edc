...
MONTHLY_INCOME_CHOICES = [
    ...
    ('5000-10000 PULA', '5000-10000 pula'),
    ('MORE THAN 10000 PULA', 'More than 10000 pula'),
    ('DO NOT WANT TO ANSWER', 'Do not want to answer')
]

COMMUNITY_INVOLVEMENT_CHOICES = [
...
ELECTION_PARTICIPATION_CHOICES = [
    ('YES', 'Yes'),
    ('NO', 'No'),
...
NEIGHBOURHOOD_PROBLEMS_CHOICES = [
    ('HIV/AIDS', 'HIV/AIDS'),
    ('SCHOOLS', 'Schools'),
    ('SEWER', 'Sewer'),
...
ADULTS_PROBLEM_SOLVING_CHOICES = [
    ('YES', 'Yes'),
    ('NO', 'No'),
